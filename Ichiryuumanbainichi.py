...
def ichiryuumanbainichi(year):
    ...
    _dates = solarTerm24.dates_of('小寒', year) + solarTerm24.dates_of('大寒', year)
    jyuunishi1 = '卯'
    jyuunishi2 = '子'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)
    

    _dates = solarTerm24.dates_of('立春', year) + solarTerm24.dates_of('雨水', year)
    jyuunishi1 = '丑'
    jyuunishi2 = '午'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)
            
            
    _dates = solarTerm24.dates_of('啓蟄', year) + solarTerm24.dates_of('春分', year)
    jyuunishi1 = '酉'
    jyuunishi2 = '寅'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2) 


    _dates = solarTerm24.dates_of('清明', year) + solarTerm24.dates_of('穀雨', year)
    jyuunishi1 = '子'
    jyuunishi2 = '卯'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('立夏', year) + solarTerm24.dates_of('小満', year)
    jyuunishi1 = '卯'
    jyuunishi2 = '辰'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('芒種', year) + solarTerm24.dates_of('夏至', year)
    jyuunishi1 = '巳'
    jyuunishi2 = '午'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('小暑', year) + solarTerm24.dates_of('大暑', year)
    jyuunishi1 = '酉'
    jyuunishi2 = '午'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('立秋', year) + solarTerm24.dates_of('処暑', year)
    jyuunishi1 = '子'
    jyuunishi2 = '未'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('白露', year) + solarTerm24.dates_of('秋分', year)
    jyuunishi1 = '卯'
    jyuunishi2 = '申'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('寒露', year) + solarTerm24.dates_of('霜降', year)
    jyuunishi1 = '酉'
    jyuunishi2 = '午'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('立冬', year) + solarTerm24.dates_of('小雪', year)
    jyuunishi1 = '酉'
    jyuunishi2 = '戌'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)         
    ...
    _dates = solarTerm24.dates_of('大雪', year) + solarTerm24.dates_of('冬至', year)
    jyuunishi1 = '亥'
    jyuunishi2 = '子'
    result += _dates_jyuunishi1_jyuunishi2(_dates, jyuunishi1, jyuunishi2)  
